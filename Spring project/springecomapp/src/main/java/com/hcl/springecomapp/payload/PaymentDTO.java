...
public class PaymentDTO {
	...
	private String paymentMethod;//cc,online,cod
	...
	public String toString() {
		return "PaymentDTO [paymentId=" + paymentId + ", paymentMethod=" + paymentMethod + ", pgPaymentId="
				+ pgPaymentId + ", pgStatus=" + pgStatus + ", pgResponseMessage=" + pgResponseMessage + ", pgName="
				+ pgName + "]";
	}
